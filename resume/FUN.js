        ...
        class DrawLoad {
            ...
            currentCircle() {
                this.context.save();
                this.context.strokeStyle = "#A67F78"; //设置描边样式
                this.context.lineWidth = 8; //设置线宽
                this.context.beginPath(); //路径开始
                this.context.arc(this.centerX, this.centerY, 100, -Math.PI / 2, -Math.PI / 2 + this.per * this.rad, false); //用于绘制圆弧this.context.arc(x坐标，y坐标，半径，起始角度，终止角度，顺时针/逆时针)
            ...
            text() {
                ...
                this.context.fillStyle = "#A67F78"; //设置描边样式
